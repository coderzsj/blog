...
<p>作为公司的技术负责人，我每几天都会Code Review团队里面所有人的代码，一直要求他们把不用的代码去掉，但他们的应对方式总是加两个//。注释掉他们写的代码，而不是去做真正的删除动作。他们总有自己的理由，“这只是暂时注释掉，后面会用到”，但最终的结果是那些代码就像尸体一样，一直在那里，干扰着团队人员正常的思路。所以我只能强制性让他们那些“暂时没有用，以后会用到的代码”干掉 。</p>
<p>2、前期任务进度安排和分配</p>
...
<p>测试用例应该尽可能详细，尽量保证测试用例走完能确保产品能上线发布。</p>
<h2 id="二、where-文档应该放在何处" tabindex="-1"><a class="header-anchor" href="#二、where-文档应该放在何处" aria-hidden="true">#</a> 二、WHERE - 文档应该放在何处</h2>
...
<h2 id="三、what-什么是功能需求设计文档-应该包含那些内容" tabindex="-1"><a class="header-anchor" href="#三、what-什么是功能需求设计文档-应该包含那些内容" aria-hidden="true">#</a> 三、WHAT - 什么是功能需求设计文档 &amp; 应该包含那些内容</h2>
...
<ul>
<li>医生给患者测量血压，并记录到系统中。</li>
<li>上海华山医院肾内科的王主任医生在给32号病区1 号病床的患者刘阿姨测量血压，将测量到的血压100/70mmHg输入到透析管理系统。</li>
</ul>
<p>哪种方式更便于理解？特别是对医疗知识不太了解的码农们。当然可能有人觉得第一种方式更简洁。可能是我举的例子不够好，也可能是我的理解能力不够强。（但不要怀疑我的智商！哈哈哈...）</p>
<h2 id="四、how-如何保证文档质量" tabindex="-1"><a class="header-anchor" href="#四、how-如何保证文档质量" aria-hidden="true">#</a> 四、HOW - 如何保证文档质量</h2>
...
<p>这块儿还得跟数转沟通呢、rchk_flag 审核标志 关系对照不上；
规则校验加了不少了</p>
</template>
