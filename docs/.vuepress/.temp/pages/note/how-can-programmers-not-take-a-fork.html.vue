<template><h2 id="程序员如何在百忙之中不走岔路-不白忙" tabindex="-1"><a class="header-anchor" href="#程序员如何在百忙之中不走岔路-不白忙" aria-hidden="true">#</a> 程序员如何在百忙之中不走岔路，不白忙!</h2>
...
<h2 id="二、别什么事都做-得分优先级-必要时更得和别人和领导沟通" tabindex="-1"><a class="header-anchor" href="#二、别什么事都做-得分优先级-必要时更得和别人和领导沟通" aria-hidden="true">#</a> 二、别什么事都做，得分优先级，必要时更得和别人和领导沟通</h2>
...
<p>那怎么样才能拒掉一些事情呢？</p>
<h2 id="建议二-靠沟通" tabindex="-1"><a class="header-anchor" href="#建议二-靠沟通" aria-hidden="true">#</a> 建议二：靠沟通</h2>
...
<h2 id="建议三-直接拒" tabindex="-1"><a class="header-anchor" href="#建议三-直接拒" aria-hidden="true">#</a> 建议三：直接拒</h2>
<p>比如事情已经很忙了，而且此类事情有过领导和同事拒掉的先例，那么直接拒掉，不拒白不拒。</p>
<h2 id="建议四-分清优先级" tabindex="-1"><a class="header-anchor" href="#建议四-分清优先级" aria-hidden="true">#</a> 建议四：分清优先级</h2>
<p>比如某个事情，不得不做，但优先级不高，那么可以直接说，这事情目前没时间，估计要等到3天后再做。</p>
<p>指不定别人3天后这个事情就自己解决了。</p>
<h2 id="三、百忙中如何提升效率" tabindex="-1"><a class="header-anchor" href="#三、百忙中如何提升效率" aria-hidden="true">#</a> 三、百忙中如何提升效率</h2>
...
<h2 id="四、我见过的在百忙中迷失自己的案例-警示效果" tabindex="-1"><a class="header-anchor" href="#四、我见过的在百忙中迷失自己的案例-警示效果" aria-hidden="true">#</a> 四、我见过的在百忙中迷失自己的案例（警示效果）</h2>
...
<h2 id="五、在百忙中提升自己能力的一些方法" tabindex="-1"><a class="header-anchor" href="#五、在百忙中提升自己能力的一些方法" aria-hidden="true">#</a> 五、在百忙中提升自己能力的一些方法</h2>
...
<p>3、得靠一定的目标来激励自己，比如发博文能名利双收，就凭这点，我会努力写博客。又如，我听说写书更能展示自己的实力，我就用了2年时间，完成了两本，有一本尚在写作中。</p>
...
<p>负载均衡，限流，模块间的消息队列，缓存，热备冗余，数据库集群等知识。</p>
</template>
