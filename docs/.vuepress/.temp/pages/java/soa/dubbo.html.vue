<template><h2 id="dubbo" tabindex="-1"><a class="header-anchor" href="#dubbo" aria-hidden="true">#</a> Dubbo</h2>
...
<h2 id="dubbo-超时时间" tabindex="-1"><a class="header-anchor" href="#dubbo-超时时间" aria-hidden="true">#</a> Dubbo 超时时间</h2>
...
<h2 id="注册中心" tabindex="-1"><a class="header-anchor" href="#注册中心" aria-hidden="true">#</a> 注册中心</h2>
<p>Zookeeper 注册中心:</p>
<p>基于分布式协调系统 Zookeeper 实现，采用 Zookeeper 的 watch 机制实现数据变更;</p>
<h2 id="dubbo-和-spring-cloud" tabindex="-1"><a class="header-anchor" href="#dubbo-和-spring-cloud" aria-hidden="true">#</a> Dubbo 和 Spring Cloud</h2>
...
<h2 id="负载均衡策略" tabindex="-1"><a class="header-anchor" href="#负载均衡策略" aria-hidden="true">#</a> 负载均衡策略</h2>
<p>Dubbo提供了4中负载均衡策略</p>
<h3 id="_1-random-loadbalance-随机均衡算法" tabindex="-1"><a class="header-anchor" href="#_1-random-loadbalance-随机均衡算法" aria-hidden="true">#</a> ① Random LoadBalance（随机均衡算法）</h3>
<p>随机，按权重设置随机概率。</p>
<p>在一个截面上碰撞的概率高，但调用量越大分布越均匀，而且按概率使用权重后也比较均匀，有利于动态调整提供者权重。</p>
<h3 id="_2-roundrobin-loadbalance-权重轮询均衡算法" tabindex="-1"><a class="header-anchor" href="#_2-roundrobin-loadbalance-权重轮询均衡算法" aria-hidden="true">#</a> ② RoundRobin LoadBalance（权重轮询均衡算法）</h3>
...
<h3 id="_3-leastaction-loadbalance-最少活跃调用数均衡算法" tabindex="-1"><a class="header-anchor" href="#_3-leastaction-loadbalance-最少活跃调用数均衡算法" aria-hidden="true">#</a> ③ LeastAction LoadBalance（最少活跃调用数均衡算法）</h3>
<p>最少活跃调用数，相同活跃数的随机，活跃数指调用前后计数差。</p>
<p>使慢的提供者收到更少请求，因为越慢的提供者的调用前后技术差会越大。</p>
<h3 id="_4-consistenthash-loadbalance-一致性hash均衡算法" tabindex="-1"><a class="header-anchor" href="#_4-consistenthash-loadbalance-一致性hash均衡算法" aria-hidden="true">#</a> ④ ConsistentHash LoadBalance（一致性Hash均衡算法）</h3>
...
<p>环形hash空间</p>
<p>考虑通常的hash算法都是将value映射到一个32位的key值，也即是0~2^32-1次方的数值空间。可以将这个空间想象成一个首（0）尾(2^32-1)相接的圆环，如：</p>
