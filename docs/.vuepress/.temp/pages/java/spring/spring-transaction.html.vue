<template><h2 id="spring-事务" tabindex="-1"><a class="header-anchor" href="#spring-事务" aria-hidden="true">#</a> spring 事务</h2>
<p>Spring 事务的本质其实就是数据库对事务的支持，没有数据库的事务支持，spring 是无法提供事务功能的。对于纯 JDBC 操作数据库，想要用到事务，可以按照以下步骤进行：</p>
<h3 id="事务传播行为" tabindex="-1"><a class="header-anchor" href="#事务传播行为" aria-hidden="true">#</a> 事务传播行为</h3>
...
<h2 id="spring-的事务机制" tabindex="-1"><a class="header-anchor" href="#spring-的事务机制" aria-hidden="true">#</a> Spring 的事务机制</h2>
...
<h3 id="aop-代理的两种实现" tabindex="-1"><a class="header-anchor" href="#aop-代理的两种实现" aria-hidden="true">#</a> AOP 代理的两种实现</h3>
<p>Jdk 是代理接口，私有方法必然不会存在在接口里，所以就不会被拦截到；</p>
<p>Cglib 是子类，private 的方法照样不会出现在子类里，也不能被拦截。</p>
<h2 id="spring-事务的传播属性" tabindex="-1"><a class="header-anchor" href="#spring-事务的传播属性" aria-hidden="true">#</a> Spring 事务的传播属性</h2>
...
<h3 id="spring-声明式事务" tabindex="-1"><a class="header-anchor" href="#spring-声明式事务" aria-hidden="true">#</a> spring 声明式事务</h3>
<p><RouterLink to="/java/basic/java%E7%9A%84%E5%BC%82%E5%B8%B8.html">Java检查型异常和非检查型异常</RouterLink></p>
<p>Spring 声明式事务管理默认对非检查型异常和运行时异常进行事务回滚，而对检查型异常则不进行回滚操作</p>
<h3 id="java-中抛异常后如何使事务回滚" tabindex="-1"><a class="header-anchor" href="#java-中抛异常后如何使事务回滚" aria-hidden="true">#</a> java 中抛异常后如何使事务回滚</h3>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">Try</span><span class="token punctuation">{</span>undefined
    …………
<span class="token punctuation">}</span> <span class="token keyword">catch</span> <span class="token punctuation">(</span><span class="token class-name">Exception</span> e<span class="token punctuation">)</span> <span class="token punctuation">{</span>undefined
    …………
    <span class="token class-name">Throw</span> <span class="token keyword">new</span> <span class="token class-name">RuntimeException</span><span class="token punctuation">(</span>e<span class="token punctuation">)</span><span class="token punctuation">;</span>
