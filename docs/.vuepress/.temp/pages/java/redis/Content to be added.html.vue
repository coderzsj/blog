<template><h3 id="redis-分布式锁依赖于-redis-如果-redis-宕机则锁失效。如何解决" tabindex="-1"><a class="header-anchor" href="#redis-分布式锁依赖于-redis-如果-redis-宕机则锁失效。如何解决" aria-hidden="true">#</a> redis 分布式锁依赖于 redis，如果 redis 宕机则锁失效。如何解决？</h3>
<p>可以做搭建主从集群，做数据备份。</p>
