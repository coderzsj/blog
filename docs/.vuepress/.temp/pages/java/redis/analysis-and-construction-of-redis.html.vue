<template><h2 id="高可用redis服务架构分析与搭建" tabindex="-1"><a class="header-anchor" href="#高可用redis服务架构分析与搭建" aria-hidden="true">#</a> 高可用Redis服务架构分析与搭建！</h2>
...
<p><img src="@source/java/redis/img/单机版redis-server，无Sentinel.png" alt=""></p>
...
<p><img src="@source/java/redis/img/主从同步redis-server，单实例Sentinel.png" alt=""></p>
...
<p><img src="@source/java/redis/img/主从同步redis-server，双实例Sentinel.png" alt=""></p>
...
<p><img src="@source/java/redis/img/主从同步redis-server，双实例Sentinel（2）.png" alt=""></p>
...
<h2 id="方案4-主从同步redis-server-三实例sentinel" tabindex="-1"><a class="header-anchor" href="#方案4-主从同步redis-server-三实例sentinel" aria-hidden="true">#</a> 方案4：主从同步Redis Server，三实例Sentinel</h2>
<p><img src="@source/java/redis/img/主从同步redis-server，三实例Sentinel.png" alt=""></p>
...
<p><img src="@source/java/redis/assets/20220414/analysis-and-construction-of-redis-1649874689906.png" alt="使用单机版一样使用redis"></p>
