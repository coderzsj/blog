...
<h2 id="跳表" tabindex="-1"><a class="header-anchor" href="#跳表" aria-hidden="true">#</a> 跳表</h2>
...
<h3 id="跳表的原理" tabindex="-1"><a class="header-anchor" href="#跳表的原理" aria-hidden="true">#</a> 跳表的原理</h3>
<p>跳表就是一种可以进行二分查找的有序链表。跳表的数据结构模型如图 1:</p>
<p><img src="@source/java/redis/img/1-1.png" alt=""></p>
...
<h2 id="redis-持久化" tabindex="-1"><a class="header-anchor" href="#redis-持久化" aria-hidden="true">#</a> Redis 持久化</h2>
<h3 id="rdb" tabindex="-1"><a class="header-anchor" href="#rdb" aria-hidden="true">#</a> RDB</h3>
...
<h4 id="rdb-持久化相关配置" tabindex="-1"><a class="header-anchor" href="#rdb-持久化相关配置" aria-hidden="true">#</a> RDB 持久化相关配置</h4>
<ul>
...
<h4 id="rdb-持久化优点" tabindex="-1"><a class="header-anchor" href="#rdb-持久化优点" aria-hidden="true">#</a> RDB 持久化优点</h4>
<ul>
<li>RDB 持久化文件小，Redis 数据恢复时速度快</li>
<li>子进程不影响父进程，父进程可以持续处理客户端命令</li>
<li>子进程 fork 时采用 copy-on-write 方式，大多数情况下，没有太多的内存消耗，效率比较好。</li>
</ul>
<h4 id="rdb-持久化缺点" tabindex="-1"><a class="header-anchor" href="#rdb-持久化缺点" aria-hidden="true">#</a> RDB 持久化缺点</h4>
<ul>
...
<h3 id="aof-持久化" tabindex="-1"><a class="header-anchor" href="#aof-持久化" aria-hidden="true">#</a> AOF 持久化</h3>
...
<h4 id="aof-持久化缺点" tabindex="-1"><a class="header-anchor" href="#aof-持久化缺点" aria-hidden="true">#</a> AOF 持久化缺点</h4>
<ul>
<li>文件体积大</li>
...
<h4 id="aof-持久化优点" tabindex="-1"><a class="header-anchor" href="#aof-持久化优点" aria-hidden="true">#</a> AOF 持久化优点</h4>
<ul>
<li>持久化频率高，数据可靠性高</li>
...
<div class="custom-container info"><p class="custom-container-title">注：数据恢复流程说明</p>
