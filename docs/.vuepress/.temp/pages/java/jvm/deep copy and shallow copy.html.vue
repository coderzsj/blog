<template><h2 id="基本类型和引用类型" tabindex="-1"><a class="header-anchor" href="#基本类型和引用类型" aria-hidden="true">#</a> 基本类型和引用类型</h2>
<h3 id="在java中数据类型可以分为两大类-基本类型和引用类型。" tabindex="-1"><a class="header-anchor" href="#在java中数据类型可以分为两大类-基本类型和引用类型。" aria-hidden="true">#</a> 在Java中数据类型可以分为两大类：基本类型和引用类型。</h3>
<p>基本类型也称为值类型，分别是字符型char，布尔型boolean以及数值型 byte、short、int、long、float、double。</p>
<p>引用类型则包括类、接口、数组、枚举等。</p>
<h3 id="内存空间分为堆和栈" tabindex="-1"><a class="header-anchor" href="#内存空间分为堆和栈" aria-hidden="true">#</a> 内存空间分为堆和栈</h3>
<p>基本类型直接在栈中存储数值，而引用类型是将引用放在栈中，实际存储的值是放在堆中，通过栈中的引用指向堆中存放的数据。</p>
<p>开发过程中，有时会遇到把现有的一个对象的所有成员属性拷贝给另一个对象的需求。</p>
<h2 id="创建对象的5种方式" tabindex="-1"><a class="header-anchor" href="#创建对象的5种方式" aria-hidden="true">#</a> 创建对象的5种方式</h2>
<p>①、通过 new 关键字</p>
...
<h2 id="clone-方法" tabindex="-1"><a class="header-anchor" href="#clone-方法" aria-hidden="true">#</a> Clone 方法</h2>
