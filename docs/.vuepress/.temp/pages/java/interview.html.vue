<template><h2 id="interview" tabindex="-1"><a class="header-anchor" href="#interview" aria-hidden="true">#</a> interview</h2>
<ol>
<li>
...
<h2 id="谈谈你的优缺点" tabindex="-1"><a class="header-anchor" href="#谈谈你的优缺点" aria-hidden="true">#</a> 谈谈你的优缺点</h2>
<p>缺点：</p>
<ol>
