<template><p>重载和重写的区别</p>
<p>重载</p>
<p>a</p>
<p>a</p>
<p>override</p>
<h2 id="_1-8、网络-io基础" tabindex="-1"><a class="header-anchor" href="#_1-8、网络-io基础" aria-hidden="true">#</a> 1.8、网络/IO基础</h2>
<p>BIO：
BIO 其实就是IO，文件读写，scoket通信，都是io操作</p>
...
<p>小标驱动大表</p>
<h2 id="buffer-缓冲区" tabindex="-1"><a class="header-anchor" href="#buffer-缓冲区" aria-hidden="true">#</a> buffer - 缓冲区</h2>
...
<h2 id="通道-channel" tabindex="-1"><a class="header-anchor" href="#通道-channel" aria-hidden="true">#</a> 通道（Channel）</h2>
...
<h2 id="多路复用器-selector" tabindex="-1"><a class="header-anchor" href="#多路复用器-selector" aria-hidden="true">#</a> 多路复用器（selector）</h2>
