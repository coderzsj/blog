<template><h2 id="解释serializable-接口的作用" tabindex="-1"><a class="header-anchor" href="#解释serializable-接口的作用" aria-hidden="true">#</a> 解释Serializable 接口的作用</h2>
...
<h2 id="礼貌" tabindex="-1"><a class="header-anchor" href="#礼貌" aria-hidden="true">#</a> 礼貌</h2>
<p>礼貌点总是没错的，这也很容易做到。主动打招呼，站直、做好、男生不要翘二郎腿，不亢不卑，面试时双眼直视对方，但也不能直勾勾地盯着人家妹子或者帅哥看，会引起面试官的不适，要适合而止，游刃有余！</p>
<p>了解ID发号器是什么、为什么、如何做？</p>
<h2 id="数据库集群、分库分表" tabindex="-1"><a class="header-anchor" href="#数据库集群、分库分表" aria-hidden="true">#</a> 数据库集群、分库分表</h2>
...
<h2 id="vesta框架简介" tabindex="-1"><a class="header-anchor" href="#vesta框架简介" aria-hidden="true">#</a> VESTA框架简介</h2>
...
<h2 id="hashmap多线程下发生死循环原因及解决" tabindex="-1"><a class="header-anchor" href="#hashmap多线程下发生死循环原因及解决" aria-hidden="true">#</a> HashMap多线程下发生死循环原因及解决</h2>
