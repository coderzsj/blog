<template><h2 id="为什么一定要用消息中间件" tabindex="-1"><a class="header-anchor" href="#为什么一定要用消息中间件" aria-hidden="true">#</a> 为什么一定要用消息中间件？</h2>
...
<h2 id="exactly-once" tabindex="-1"><a class="header-anchor" href="#exactly-once" aria-hidden="true">#</a> Exactly-Once</h2>
...
<h2 id="二、为什么要使用消息中间件" tabindex="-1"><a class="header-anchor" href="#二、为什么要使用消息中间件" aria-hidden="true">#</a> 二、为什么要使用消息中间件？</h2>
...
<p><img src="@source/java/message-queue/img/使用mq实现系统解耦.png" alt=""></p>
<p>2、异步调用</p>
<p>假设你有一个系统调用链路，是系统A调用系统B，一般耗时20ms；系统B调用系统C，一般耗时200ms；系统C调用系统D，一般耗时2s，如下图所示。</p>
<p><img src="@source/java/message-queue/img/异步调用解决系统调用链路耗时.png" alt=""></p>
<p>现在最大的问题就是：</p>
...
<p>整个过程，如下图所示：</p>
<p><img src="@source/java/message-queue/img/异步调用解决系统调用链路耗时2.png" alt=""></p>
<p>3、流量削峰</p>
...
<p><img src="@source/java/message-queue/img/流量削峰.png" alt=""></p>
...
<p><img src="@source/java/message-queue/img/流量削峰2.png" alt=""></p>
...
<p><img src="@source/java/message-queue/img/流量削峰3.png" alt=""></p>
