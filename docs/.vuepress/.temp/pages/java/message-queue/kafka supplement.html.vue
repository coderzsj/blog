...
<h3 id="和其他消息队列相比-kafka-的优势在哪里" tabindex="-1"><a class="header-anchor" href="#和其他消息队列相比-kafka-的优势在哪里" aria-hidden="true">#</a> 和其他消息队列相比,Kafka 的优势在哪里？</h3>
<p>Kafka 相比其他消息队列主要的优势如下：</p>
<ol>
<li>极致的性能 ：设计中大量使用了批量处理和异步的思想，最高可以每秒处理千万级别的消息。</li>
<li>生态系统兼容性好 ：Kafka 与周边生态系统的兼容性是最好的，在大数据和流计算领域。</li>
</ol>
<h3 id="队列模型了解吗-kafka的消息模型知道吗" tabindex="-1"><a class="header-anchor" href="#队列模型了解吗-kafka的消息模型知道吗" aria-hidden="true">#</a> 队列模型了解吗？Kafka的消息模型知道吗？</h3>
...
<h4 id="发布-订阅模型-kafka-消息模型" tabindex="-1"><a class="header-anchor" href="#发布-订阅模型-kafka-消息模型" aria-hidden="true">#</a> 发布-订阅模型:Kafka 消息模型</h4>
...
<h2 id="二、kafka基本架构" tabindex="-1"><a class="header-anchor" href="#二、kafka基本架构" aria-hidden="true">#</a> 二、Kafka基本架构</h2>
...
<h3 id="kafka-的多副本机制" tabindex="-1"><a class="header-anchor" href="#kafka-的多副本机制" aria-hidden="true">#</a> Kafka 的多副本机制</h3>
...
<h3 id="zookeeper-在-kafka-中的作用" tabindex="-1"><a class="header-anchor" href="#zookeeper-在-kafka-中的作用" aria-hidden="true">#</a> Zookeeper 在 Kafka 中的作用</h3>
...
<h3 id="kafka-如何保证消息的消费顺序" tabindex="-1"><a class="header-anchor" href="#kafka-如何保证消息的消费顺序" aria-hidden="true">#</a> Kafka 如何保证消息的消费顺序？</h3>
...
<h3 id="kafka-如何保证消息不丢失" tabindex="-1"><a class="header-anchor" href="#kafka-如何保证消息不丢失" aria-hidden="true">#</a> Kafka 如何保证消息不丢失</h3>
<h4 id="生产者丢失消息的情况" tabindex="-1"><a class="header-anchor" href="#生产者丢失消息的情况" aria-hidden="true">#</a> 生产者丢失消息的情况</h4>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">T</span><span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>如果消息发送失败的话，我们检查失败的原因之后重新发送即可！</p>
...
<h4 id="消费者丢失消息的情况" tabindex="-1"><a class="header-anchor" href="#消费者丢失消息的情况" aria-hidden="true">#</a> 消费者丢失消息的情况</h4>
...
<h4 id="kafka-弄丢了消息" tabindex="-1"><a class="header-anchor" href="#kafka-弄丢了消息" aria-hidden="true">#</a> Kafka 弄丢了消息</h4>
...
<h3 id="kafka-如何保证消息不重复消费" tabindex="-1"><a class="header-anchor" href="#kafka-如何保证消息不重复消费" aria-hidden="true">#</a> Kafka 如何保证消息不重复消费</h3>
...
<h3 id="reference" tabindex="-1"><a class="header-anchor" href="#reference" aria-hidden="true">#</a> Reference</h3>
<ul>
<li>Kafka 官方文档： <a href="https://kafka.apache.org/documentation/" target="_blank" rel="noopener noreferrer">https://kafka.apache.org/documentation/<ExternalLinkIcon/></a></li>
<li>极客时间—《Kafka 核心技术与实战》第 11 节：无消息丢失配置怎么实现？</li>
</ul>
<p><a href="https://mp.weixin.qq.com/s?__biz=Mzg2OTA0Njk0OA==&amp;mid=2247486269&amp;idx=2&amp;sn=ec00417ad641dd8c3d145d74cafa09ce&amp;chksm=cea244f6f9d5cde0c8eb233fcc4cf82e11acd06446719a7af55230649863a3ddd95f78d111de&amp;token=1633957262&amp;lang=zh_CN#rd" target="_blank" rel="noopener noreferrer">Kafka 系列第三篇！10 分钟学会如何在 Spring Boot 程序中使用 Kafka 作为消息队列?<ExternalLinkIcon/></a></p>
<h2 id="三、基本原理" tabindex="-1"><a class="header-anchor" href="#三、基本原理" aria-hidden="true">#</a> 三、基本原理</h2>
...
<h2 id="_4、zookeeper在kafka的作用" tabindex="-1"><a class="header-anchor" href="#_4、zookeeper在kafka的作用" aria-hidden="true">#</a> 4、Zookeeper在kafka的作用：</h2>
