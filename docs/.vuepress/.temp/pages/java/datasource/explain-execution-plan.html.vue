<template><h2 id="explain-执行计划" tabindex="-1"><a class="header-anchor" href="#explain-执行计划" aria-hidden="true">#</a> explain 执行计划</h2>
<p>合理设计并利用索引</p>
...
<h2 id="explain中" tabindex="-1"><a class="header-anchor" href="#explain中" aria-hidden="true">#</a> explain中</h2>
<ol>
...
<ol start="4">
<li>type <Badge text="查找数据行的大概范围" /></li>
</ol>
...
<h3 id="extra" tabindex="-1"><a class="header-anchor" href="#extra" aria-hidden="true">#</a> extra</h3>
<p>Using filesort：</p>
