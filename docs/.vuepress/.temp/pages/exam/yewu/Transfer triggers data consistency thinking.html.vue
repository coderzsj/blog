<template><h2 id="转账引发的一致性思考" tabindex="-1"><a class="header-anchor" href="#转账引发的一致性思考" aria-hidden="true">#</a> 转账引发的一致性思考</h2>
...
<h2 id="事务隔离性理解" tabindex="-1"><a class="header-anchor" href="#事务隔离性理解" aria-hidden="true">#</a> 事务隔离性理解：</h2>
